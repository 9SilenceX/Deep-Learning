...
def yolo_filter_boxes(boxes, box_confidence, box_class_probs, threshold = .6):
    ...
    Note: "None" is here cuz we don't know the exact number of selected boxes, as it depends on the threshold. 
...
#Non-max Suppression ------ for selecting the right boxes
def iou(box1, box2):
