...
def initialize_with_zeros(dim):
    ...
    w, b = np.zeros((dim,1)), 0.00
    
    return w, b

# GRADED FUNCTION: propagate ____computes the cost function and its gradient.
...
# GRADED FUNCTION: optimize______update the parameters using gradient descent.
